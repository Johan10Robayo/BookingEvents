        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonDniNumber = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Persons_PersonDniNumber",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyTaxId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: false),
                    MinPurchaseAmount = table.Column<decimal>(type: "decimal(38,3)", precision: 38, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Venues_Companies_CompanyTaxId",
                        column: x => x.CompanyTaxId,
                        principalTable: "Companies",
                        principalColumn: "TaxId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(38,3)", precision: 38, scale: 3, nullable: false),
                    PaymentMethod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SubTotal = table.Column<decimal>(type: "decimal(38,3)", precision: 38, scale: 3, nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(38,3)", precision: 38, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_PersonDniNumber",
                table: "User",
                column: "PersonDniNumber");

            migrationBuilder.CreateIndex(
                name: "IX_Venues_CompanyTaxId",
                table: "Venues",
                column: "CompanyTaxId");
        }
